...
public class RegistrazioneLogopedistaFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        signUpNome = view.findViewById(R.id.registrazione_logopedista_nome);
        signUpCognome = view.findViewById(R.id.registrazione_logopedista_cognome);
        signUpEmail = view.findViewById(R.id.registrazione_logopedista_email);
        signUpCodiceFiscale = view.findViewById(R.id.registrazione_logopedista_codiceFiscale);
        signUpPassword = view.findViewById(R.id.registrazione_logopedista_password);
