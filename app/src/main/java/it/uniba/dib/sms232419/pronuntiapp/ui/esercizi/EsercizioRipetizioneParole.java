...
public class EsercizioRipetizioneParole extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        conferma_button.setOnClickListener(v -> {
            ...
            String path_audio = "esercizio2/" + trascrizione_audio + "_audio.mp3";

            // Carica l'audio su Firebase Storage
            uploadFileToFirebaseStorage(audioUri, path_audio, success -> {
                if (!success) {
                    esito[0] = false;
                }
            });
    ...
    private void uploadFileToFirebaseStorage(Uri fileUri, String path, EsercizioDenominazioneImmagine.OnUploadCompleteListener callback) {
